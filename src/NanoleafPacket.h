...
#ifndef NANOLEAFPACKET_H_
#define NANOLEAFPACKET_H_
...
namespace Nanoleaf
{
class NanoleafPacket : public BaseLib::Systems::Packet
{
    public:
		enum class Category
		{
        ...
        //Properties
        NanoleafPacket();
        NanoleafPacket(Category category, int32_t senderAddress, int32_t destinationAddress, uint8_t messageType, PVariable json, int64_t timeReceived = 0);
        virtual ~NanoleafPacket();
